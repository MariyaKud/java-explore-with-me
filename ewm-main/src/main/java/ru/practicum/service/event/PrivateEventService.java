...
public interface PrivateEventService {
     ...
     *
     * @param userId id текущего пользователя
     * @param isNeedModeration отбор события, отмененных модератором с комментариями причины отмены
     ...
     */
    List<EventShortDto> getUserEvents(Long userId, boolean isNeedModeration, Integer from, Integer size);
     ...
     * При отправки на повторную модерауию события, выполняется смена статуса полученных комментариев по событию от
     * модератора, как исправленных.
     *
     * @param userId   id текущего пользователя
     * @param eventId  id события
